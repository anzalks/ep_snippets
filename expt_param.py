...
animalID = 'G614' #nan
sex = 'F' #nan
dateofBirth = datetime.date(2021, 10, 7) #nan
dateofInj = datetime.date(2021, 11, 7) #nan
dateofExpt = datetime.date(2021, 12, 23) #nan
sliceThickness = 400 #nan
...
ageAtInj = (dateofInj	- dateofBirth) #nan
ageAtExp = (dateofExpt	- dateofBirth) #nan
incubation = (ageAtExp	- ageAtInj) #nan
...
squareSize = frameSize / (gridSize * objMag) #nan
isBatch = datetime.date(2021, 7, 30) #nan
ispH = 7.29 #nan
...
exptTypes = ['GapFree','IR','CurrentStep','1sq20Hz','FreqSweep','LTMSeq','LTMRand','convergence', 'Rmp', 'Rin', 'Thresh', 'Pre_po', 'Pre_pat', 'Train',  'Pos_po', 'Pos_pat'] #nan
exptType = exptTypes[15] #nan
conditions = ['Control','Gabazine'] #nan
condition = conditions[0] #nan
Fs = 2e4 # sampling frequency
signalScaling = 1 # usually 1, but sometimes the DAQ does not save current values in proper units
baselineSubtraction = True #nan
...
filter = filters[0] #nan
filterHighCutoff = 2e4 #nan
